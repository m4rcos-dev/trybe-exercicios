...
function consertaPosicao (li){
    li.target.className = 'tech';
}

secondLi.addEventListener('click', consertaPosicao);
thirdLi.addEventListener('click', consertaPosicao);
...
function mudacor (local){
  let colorir = local;
  colorir.className = 'colorir';
}
