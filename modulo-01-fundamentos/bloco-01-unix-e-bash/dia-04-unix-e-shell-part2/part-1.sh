...
echo -e "1 - As lágrimas do Chuck Norris curam o câncer. O problema é que ele é tão macho que não chora nunca. Nunca!

2 - Chuck Norris não dorme. Ele espera.

3 - Chuck Norris está atualmente processando a NBC. Ele alega que Lei e Ordem são os nomes patenteados para suas pernas (Lei a esquerda, Ordem a direita)." >> phrases2.txt
