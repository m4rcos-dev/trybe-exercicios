...
echo -e "\nCriando arquivo phrases.txt com frases do StarWars"
echo -e "Que monte de sucata
Não, eu sou seu pai
Que a força estja com você
Ajude-me Obi-Wan Kenobi
Aquilo não é lua, é uma estação espacial
Estes são os androids que você procura
Quando o deixei, eu era só o aprendiz: agora sou o mestre" >> phrases.txt
sleep $delay
